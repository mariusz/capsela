...
},
{
    ...
    loadController: function(baseDir, name) {
        ...
        var cls = require(baseDir + '/' + name + '/Controller').Controller;
        
        this.addController(new cls(), name);
    },
    ...
    service: function(request) {
        ...
        if (controller) {
            ...
            if (method) {
                ...
                var result = method.apply(controller, [request]);

                if (result instanceof capsela.View) {
                    result.urlFactory = this;
                }
